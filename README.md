...
registry infrastructure décrit par le code l'infrastructure à provisionner pour ... de i-love-automation.
...
- [Github Actions](https://docs.github.com/en/actions) est l'outil d'intégration et de déploiement continu intégré à GitHub
    - L'historique des déploiements est disponible [sous l'onglet Actions](https://github.com/i-love-automation/registry-infrastructure/actions/)
- Secrets du dépôt :
...
- [AWS](https://aws.amazon.com/) est la plateforme de services Cloud proposée par Amazon.
    - Utilisateur : `i-love-automation.registry.infrastructure`
...
- [Terraform Cloud](https://app.terraform.io/) est la plateforme proposée par HashiCorp pour administrer les modifications d'infrastructure
    ...
    - Workspaces : `registry`
        - [registry-production](https://app.terraform.io/app/i-love-automation/workspaces/registry)
    - Variables
